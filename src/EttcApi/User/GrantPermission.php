...
/**
 * Grants a permission for the given user, after checking for permissions
 *
 * @api {post} /user/grantPermission grant permission
 * @apiName grantPermission
 * @apiVersion 0.1.0
 * @apiGroup User
 *
 * @apiParam {int} userId         id of user to grant permission for
...
class GrantPermission extends AbstractRoutable
{
    /**
     * Grants a permission for the given user, after checking for permissions
     ...
     */
     ...
     private function checkPermission()
     {
         ...
         if ($user) {
             $permissionObj = new Permission($this->getDb(), $user);
             $hasPermission = $permissionObj->get("ettcApi/user/grantPermission");
         }
